...
module.exports.test = function (Observer) {
    ...
    describe('create observer with methodsReplace', function () {
        let observer1 = new Observer({methodsReplace: true});
        ...
        it('observer1.listen should be function', function () {
            expect(typeof observer1.listen === 'function').to.be.equal(true);
        });
         it('observer2.subscribe', function () {
             observer2.subscribe('e',cb);
             observer2.publish('e',3);
            expect(result === 3).to.be.equal(true);
        });
          it('observer2.unsubscribe', function () {
              observer2.unsubscribe('e',cb);
              observer2.publish('e',5);
              expect(result === 5).to.be.equal(false);
        });
        it('observer2.listen should not be function', function () {
            expect(typeof observer2.listen !== 'function').to.be.equal(true);
        });
        it('observer3.listen should be function', function () {
            expect(typeof observer3.listen === 'function').to.be.equal(true);
        });
        it('observer2.on should be function', function () {
            expect(typeof observer2.on === 'function').to.be.equal(true);
        });
